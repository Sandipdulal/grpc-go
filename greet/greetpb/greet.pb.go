...
type GreetMayTimesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GreetMayTimesRequest) Reset() {
	*x = GreetMayTimesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GreetMayTimesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetMayTimesRequest) ProtoMessage() {}

func (x *GreetMayTimesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_greetpb_greet_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetMayTimesRequest.ProtoReflect.Descriptor instead.
func (*GreetMayTimesRequest) Descriptor() ([]byte, []int) {
	return file_greet_greetpb_greet_proto_rawDescGZIP(), []int{3}
}

func (x *GreetMayTimesRequest) GetGreeting() *Greeting {
	if x != nil {
		return x.Greeting
	}
	return nil
...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x22, 0x43, 0x0a, 0x14, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x79, 0x54, 0x69, 0x6d, 0x65,
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x12, 0x1b,
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x79, 0x54,
	...
	0x28, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*GreetMayTimesRequest)(nil),   // 3: greet.GreetMayTimesRequest
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.GreetMayTimesRequest.greeting:type_name -> greet.Greeting
	0, // 2: greet.LongGreetRequest.greeting:type_name -> greet.Greeting
	1, // 3: greet.GreetService.Greet:input_type -> greet.GreetRequest
	3, // 4: greet.GreetService.GreetManyTimes:input_type -> greet.GreetMayTimesRequest
...
func file_greet_greetpb_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greet_greetpb_greet_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GreetMayTimesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
